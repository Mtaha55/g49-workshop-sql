...
# select* FROM City;
#
# 3: Get everything on the cities whose district is "aceh"cityPRIMARYCountryCodecity_ibfk_1country
#
# (Hint: 2 rows)
...
#
# select district countrycode from city where population < 1000;
#
